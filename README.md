...
- directory records with standard `.` and `..` entries, written as single non-interleaved directory sections and parsed from compatible multi-extent/interleaved directory sections
